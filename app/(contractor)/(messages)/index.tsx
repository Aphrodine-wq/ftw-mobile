      ...
      <SafeAreaView className="flex-1 bg-surface">
        ...
        <FlatList
          ...
          renderItem={({ item }: { item: MockConversation }) => (
            ...
            >
              {/* Avatar */}
              <View className="w-12 h-12 rounded-full bg-brand-50 items-center justify-center mr-3">
              ...
              {/* Unread badge */}
              {item.unread > 0 && (
                <View className="bg-brand-600 rounded-full w-5 h-5 items-center justify-center">
    ...
    <SafeAreaView className="flex-1 bg-surface" edges={["top"]}>
      ...
      >
        ...
        <View className="flex-row items-end px-4 py-3 bg-white border-t border-border">
          <TextInput
            className="flex-1 bg-surface rounded-xl px-4 py-3 text-dark text-base mr-3 max-h-24"
