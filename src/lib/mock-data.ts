...
export const mockProjects = [
  {
    ...
    milestones: [
      { id: "m1", title: "Demo & Rough-In", amount: 7700, status: "paid" as const, dueDate: "2026-02-22", completedDate: "2026-02-20" },
      { id: "m2", title: "Cabinets & Plumbing", amount: 11550, status: "paid" as const, dueDate: "2026-03-08", completedDate: "2026-03-06" },
      { id: "m3", title: "Countertops & Backsplash", amount: 9625, status: "in_progress" as const, dueDate: "2026-04-02" },
      { id: "m4", title: "Appliances & Trim", amount: 5775, status: "pending" as const, dueDate: "2026-04-15" },
      { id: "m5", title: "Final Inspection & Punch List", amount: 3850, status: "pending" as const, dueDate: "2026-04-22" },
    ],
    tasks: [
  ...
  },
  {
    ...
    milestones: [
      { id: "m6", title: "Tear-Off & Decking Repair", amount: 4260, status: "paid" as const, dueDate: "2026-03-14", completedDate: "2026-03-13" },
      { id: "m7", title: "Underlayment & Shingles", amount: 5680, status: "in_progress" as const, dueDate: "2026-03-22" },
      { id: "m8", title: "Flashings, Ridge & Cleanup", amount: 2840, status: "pending" as const, dueDate: "2026-03-28" },
      { id: "m9", title: "Final Inspection", amount: 1420, status: "pending" as const, dueDate: "2026-04-02" },
    ],
    tasks: [
  ...
  },
  {
    ...
    milestones: [
      { id: "m10", title: "Prep & Prime", amount: 1260, status: "paid" as const, dueDate: "2026-01-13", completedDate: "2026-01-12" },
      { id: "m11", title: "Walls — First Coat", amount: 1260, status: "paid" as const, dueDate: "2026-01-15", completedDate: "2026-01-14" },
      { id: "m12", title: "Walls — Second Coat & Trim", amount: 1260, status: "paid" as const, dueDate: "2026-01-17", completedDate: "2026-01-17" },
      { id: "m13", title: "Touch-Up & Walkthrough", amount: 420, status: "paid" as const, dueDate: "2026-01-18", completedDate: "2026-01-18" },
    ],
    tasks: [
...
export const mockAiEstimate: AiEstimateResult = {
  ...
  total: 34200,
  breakdown: [
    { division: "02 Existing Conditions", item: "Demolition & haul-off", cost: 3200 },
    { division: "06 Wood/Plastics", item: "Cabinets & countertops", cost: 9800 },
    { division: "07 Thermal/Moisture", item: "Waterproofing & insulation", cost: 1200 },
    { division: "09 Finishes", item: "Tile, backsplash, paint", cost: 4600 },
    { division: "22 Plumbing", item: "Fixtures & rough-in", cost: 3800 },
    { division: "26 Electrical", item: "Wiring, panels, fixtures", cost: 4200 },
    { division: "11 Equipment", item: "Appliance installation", cost: 2400 },
    { division: "01 General", item: "Permits, cleanup, dumpster", cost: 1800 },
  ],
  lineItems: [
    { description: "Cabinet demolition & disposal", quantity: 1, unit: "LS", unitCost: 1800, total: 1800 },
    { description: "Flooring removal", quantity: 200, unit: "SF", unitCost: 3.5, total: 700 },
    { description: "Dumpster rental (20yd)", quantity: 1, unit: "EA", unitCost: 700, total: 700 },
    { description: "Custom cabinets — base & wall", quantity: 18, unit: "LF", unitCost: 280, total: 5040 },
    { description: "Quartz countertops — fabricated", quantity: 45, unit: "SF", unitCost: 85, total: 3825 },
    { description: "Undermount sink + faucet", quantity: 1, unit: "EA", unitCost: 650, total: 650 },
    { description: "Subway tile backsplash", quantity: 32, unit: "SF", unitCost: 18, total: 576 },
    { description: "LVP flooring install", quantity: 200, unit: "SF", unitCost: 8.5, total: 1700 },
    { description: "Interior paint — walls & ceiling", quantity: 1, unit: "LS", unitCost: 1800, total: 1800 },
    { description: "Rough plumbing — relocate drain", quantity: 1, unit: "LS", unitCost: 2200, total: 2200 },
    { description: "Electrical — 20A circuits + GFCI", quantity: 4, unit: "EA", unitCost: 450, total: 1800 },
    { description: "Recessed lighting install", quantity: 8, unit: "EA", unitCost: 175, total: 1400 },
    { description: "Appliance hookup (gas + electric)", quantity: 4, unit: "EA", unitCost: 250, total: 1000 },
    { description: "Permits & inspections", quantity: 1, unit: "LS", unitCost: 1200, total: 1200 },
  ],
  exclusions: [
...
export const mockSubJobs: SubJob[] = [
  { id: "sj1", title: "Quartz Countertop Install", description: "Fabricate and install 45 SF quartz countertops with undermount sink cutout. Template already done.", category: "Countertops", skills: ["Stone fabrication", "Templating", "Sink cutouts"], budgetMin: 4500, budgetMax: 6000, deadline: "2026-04-05", location: "Austin, TX", status: "open", bidCount: 2, paymentPath: "contractor_escrow", urgency: "medium", contractorName: "Marcus Johnson", contractorRating: 4.9, projectName: "Kitchen Remodel", milestoneLabel: "Countertops & Backsplash" },
  { id: "sj2", title: "Tile Backsplash + LVP Flooring", description: "Install 32 SF subway tile backsplash and 200 SF LVP flooring in kitchen. Materials on site.", category: "Flooring", skills: ["Tile setting", "LVP install", "Grout & seal"], budgetMin: 5000, budgetMax: 7000, deadline: "2026-04-10", location: "Austin, TX", status: "open", bidCount: 1, paymentPath: "passthrough_escrow", urgency: "low", contractorName: "Marcus Johnson", contractorRating: 4.9, projectName: "Kitchen Remodel", milestoneLabel: "Countertops & Backsplash" },
  { id: "sj3", title: "Seamless Gutter Install", description: "Install 180 LF seamless aluminum gutters with downspouts. Old gutters removed.", category: "Roofing", skills: ["Gutter fabrication", "Fascia repair"], budgetMin: 2800, budgetMax: 3800, deadline: "2026-03-30", location: "Round Rock, TX", status: "open", bidCount: 3, paymentPath: "contractor_escrow", urgency: "high", contractorName: "James Mitchell", contractorRating: 4.7, projectName: "Roof Replacement", milestoneLabel: "Flashings, Ridge & Cleanup" },
  { id: "sj4", title: "Bathroom Plumbing Rough-In", description: "Rough-in plumbing for master bath remodel. Relocate drain, supply lines, and vent stack.", category: "Plumbing", skills: ["Rough plumbing", "Drain relocation", "Venting"], budgetMin: 3200, budgetMax: 4500, deadline: "2026-04-08", location: "Cedar Park, TX", status: "in_progress", bidCount: 2, paymentPath: "passthrough_escrow", urgency: "medium", contractorName: "Marcus Johnson", contractorRating: 4.9, projectName: "Bathroom Reno", milestoneLabel: "Plumbing Rough-In" },
  { id: "sj5", title: "Flashing & Ridge Cap", description: "Install pipe boots, wall flashings, and ridge cap on 3200 SF roof. Shingles already done.", category: "Roofing", skills: ["Flashing", "Ridge vent", "Waterproofing"], budgetMin: 1800, budgetMax: 2600, deadline: "2026-03-28", location: "Round Rock, TX", status: "open", bidCount: 0, paymentPath: "contractor_escrow", urgency: "high", contractorName: "James Mitchell", contractorRating: 4.7, projectName: "Roof Replacement", milestoneLabel: "Flashings, Ridge & Cleanup" },
];

export const mockSubBids: SubBid[] = [
  { id: "sb1", subJobId: "sj1", amount: 5200, message: "15 years in stone. Can start Monday.", timeline: "3-4 days", status: "pending", subContractorName: "Jake Wilson" },
  { id: "sb2", subJobId: "sj2", amount: 5800, message: "Tile and flooring crew available next week.", timeline: "4-5 days", status: "pending", subContractorName: "Jake Wilson" },
  { id: "sb3", subJobId: "sj4", amount: 3800, message: "Licensed plumber, 20 years experience.", timeline: "2-3 days", status: "accepted", subContractorName: "Jake Wilson" },
];
